...
if( !class_exists('QcConversionTracker') ){
	...
	class QcConversionTracker{
		...
		public $plugin_text_domain = "woochatbot";
		public $add_cart_selector = "#woo-chatbot-add-cart-button";
		public $reached_cheackout_selector = ".woo-chatbot-checkout-link";
        public $report_button_parent= '.woo-chatbot-tabs nav ul';
        public $report_button_dom = '<li tab-data="report"><a  id="qcld-con-tracker-button" data-toggle="modal" href="#"><span class="woowbot-admin-tab-icon"> <i class="fa fa-filter"></i></span>
                                          <span class="woowbot-admin-tab-name">Conversion Report </span></a></li>';
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="custom" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                    <div class="col-sm-4">
                                        <input type="text" name="con_traker_from" class="form-control" id="con_traker_from" placeholder="<?php _e('From', $this->plugin_text_domain); ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" name="con_traker_from" class="form-control" id="con_traker_to" placeholder="<?php _e('To', $this->plugin_text_domain); ?>">
                                    </div>
                                    <div class="col-sm-4">
